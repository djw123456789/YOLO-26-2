...
if __name__ == '__main__':
    model_path = 'D:/vscode/workspace/recurrencePaper/YOLO-26-2/outputs/no-pretrained/2160-yolo26-wgfs-e200-b16-s42/weights/best.pt'
    model = YOLO(model_path)  # 选择训练好的权重路径
    result = model.val(
                       data='./datasets/tt100k_aug_2160/TT100K.yaml',
                       ...
                       name='2160-yolo26-wgfs-e200-b16-s42-test',
                       )
