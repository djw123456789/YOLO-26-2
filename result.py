...
if __name__ == '__main__':
    # 选择训练好的权重路径
    model_path = 'D:/vscode/workspace/recurrencePaper/YOLO-26-2/outputs/no-pretrained/2160-yolo26-aisc-exp1-e200-b16-s42/weights/best.pt'
    # 设置用于计算指标的图像尺寸
    imgsz = 640
    ...
    result = model.val(data='./datasets/tt100k_aug_2160/TT100K.yaml',
                        ...
                        name='2160-yolo26-aisc-exp1-e200-b16-s42-test',
